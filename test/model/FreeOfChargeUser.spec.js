...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.FreeOfChargeUser();
  });
  ...
  describe('FreeOfChargeUser', function() {
    it('should create an instance of FreeOfChargeUser', function() {
      // uncomment below and update the code to test FreeOfChargeUser
      //var instane = new ViaNettIntegrationApi.FreeOfChargeUser();
      //expect(instance).to.be.a(ViaNettIntegrationApi.FreeOfChargeUser);
    });
