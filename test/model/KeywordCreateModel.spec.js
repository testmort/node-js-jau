...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.KeywordCreateModel();
  });
  ...
  describe('KeywordCreateModel', function() {
    it('should create an instance of KeywordCreateModel', function() {
      // uncomment below and update the code to test KeywordCreateModel
      //var instane = new ViaNettIntegrationApi.KeywordCreateModel();
      //expect(instance).to.be.a(ViaNettIntegrationApi.KeywordCreateModel);
    });
