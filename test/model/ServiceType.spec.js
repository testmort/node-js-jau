...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.ServiceType();
  });
  ...
  describe('ServiceType', function() {
    it('should create an instance of ServiceType', function() {
      ...
      //var instane = new ViaNettIntegrationApi.ServiceType();
      //expect(instance).to.be.a(ViaNettIntegrationApi.ServiceType);
    });
