...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.NoContentResult();
  });
  ...
  describe('NoContentResult', function() {
    it('should create an instance of NoContentResult', function() {
      ...
      //var instane = new ViaNettIntegrationApi.NoContentResult();
      //expect(instance).to.be.a(ViaNettIntegrationApi.NoContentResult);
    });
