...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.SmsMessageBatch();
  });
  ...
  describe('SmsMessageBatch', function() {
    it('should create an instance of SmsMessageBatch', function() {
      // uncomment below and update the code to test SmsMessageBatch
      //var instane = new ViaNettIntegrationApi.SmsMessageBatch();
      //expect(instance).to.be.a(ViaNettIntegrationApi.SmsMessageBatch);
    });
