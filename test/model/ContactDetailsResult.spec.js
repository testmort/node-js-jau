...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.ContactDetailsResult();
  });
  ...
  describe('ContactDetailsResult', function() {
    it('should create an instance of ContactDetailsResult', function() {
      // uncomment below and update the code to test ContactDetailsResult
      //var instane = new ViaNettIntegrationApi.ContactDetailsResult();
      //expect(instance).to.be.a(ViaNettIntegrationApi.ContactDetailsResult);
    });
