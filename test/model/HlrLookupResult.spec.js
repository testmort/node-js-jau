...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.HlrLookupResult();
  });
  ...
  describe('HlrLookupResult', function() {
    it('should create an instance of HlrLookupResult', function() {
      // uncomment below and update the code to test HlrLookupResult
      //var instane = new ViaNettIntegrationApi.HlrLookupResult();
      //expect(instance).to.be.a(ViaNettIntegrationApi.HlrLookupResult);
    });
