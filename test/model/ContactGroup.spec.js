...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ViaNettIntegrationApi.ContactGroup();
  });
  ...
  describe('ContactGroup', function() {
    it('should create an instance of ContactGroup', function() {
      ...
      //var instane = new ViaNettIntegrationApi.ContactGroup();
      //expect(instance).to.be.a(ViaNettIntegrationApi.ContactGroup);
    });
