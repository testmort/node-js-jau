...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ViaNettIntegrationApi.Pong = factory(root.ViaNettIntegrationApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('internals')) {
        obj['internals'] = ApiClient.convertToType(data['internals'], Object);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Object} internals
   */
  exports.prototype['internals'] = undefined;
